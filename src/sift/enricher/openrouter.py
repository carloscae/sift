...
class OpenRouterEnricher(Enricher):
    ...
    def summarise(self, text: str, context: dict | None = None) -> SummaryResult:
        ...
        system_prompt = (
            ...
            "Then: **Worth knowing:** followed by 2-4 bullet points of genuinely useful "
            "or accurate points "
            "with enough specific detail to be actionable in a future conversation "
            "without re-reading the source; "
            "if reader context is provided flag relevance to their specific workflows. "
            "Then: **Weak:** one sentence on what is inaccurate, hyped, fabricated, or "
            "missing — omit if nothing is weak), "
